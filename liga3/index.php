<?php
 ...
 if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
  ...
  HTML::cabeceras(array('title'      =>'Pruebas LIGA 3',
			...
			'css'        =>array('css/LIGA.css','css/jquery-ui/jquery-ui-1.9.2.liga.min.css'),
 ...
 // Tabla con instancias
  ...
  $campos = array('*', '-fecha',"fecha_nacimiento");
 ...
 $cont = ob_get_clean();
  ...
  $config = array('js'=>array('js/jquery-3.1.1.min.js','js/jquery.liga-1.3.13.js','js/codigo.js'));
  HTML::pie($config);
?>
